...
if ($_SERVER['HTTP_HOST'] == "dev.shopclues.com" ) {
...
require_once(SITE_FS_PATH."/includes/pager/pager.class.php");
require_once(SITE_FS_PATH."/includes/pager/pager_sql.class.php");
