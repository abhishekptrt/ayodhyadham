...
?>
<input class="txtfield" type="text" name="<?=$jscal_input_name?>" id="<?=$jscal_input_name?>" size="12"  readonly value="<?=$jscal_def_date?>" <? if($validation!=''){?> alt="<?=$validation?>" emsg="<?=$validation_msg?>" <? }?>/> 
...
<script type="text/javascript">
    Calendar.setup({
        ...
        ifFormat       :    "<?=$date_for_ad?>",      // format of the input field
