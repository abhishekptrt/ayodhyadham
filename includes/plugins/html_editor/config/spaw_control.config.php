...
if(!defined(SITE_SUB_PATH)) {
	define('WITHIN_SPAW', true);
	require_once(realpath(dirname(__FILE__).'/../../../midas.inc.php') );
}
// Following line is a workaround for path problem.
$_SERVER['DOCUMENT_ROOT'] = SITE_FS_PATH;

$spaw_dir = SITE_SUB_PATH.'/includes/plugins/html_editor/';
//echo "//<br>spaw_dir: $spaw_dir";
// base url for images
$spaw_base_url = SITE_WS_PATH.'/';

// Modification By: maninde123@yahoo.com - midassoft.biz
/*
...
*/  
$spaw_root = SITE_FS_PATH.'/includes/plugins/html_editor/';
...
$spaw_imglibs = array(
  array(
    'value'   => 'uploaded_files/html_editor/',
    'text'    => 'Default',
  ),
);
